...
menu = {
    "flavours": [
        {"flavourName": "Strawberry", "count": 50},
        {"flavourName": "Chocolate", "count": 75}
    ],
    "toppings": [
...
customer_reviews = {
    "reviews": [
        {"userName": "andrew_1", "rating": 5, "comment": "Loved the chocolate flavour!"},
        {"userName": "john", "rating": 4, "comment": "Great place, but always crowded."},
        {"userName": "allison", "rating": 5, "comment": "Love the ice-creams and Coolio is super helpful!"}
    ]
}
customizations = {
    "options": [
        {"customizationName": "Sugar-Free", "details": "Available for most flavours."},
